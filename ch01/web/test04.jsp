...
<body>
<div class="container">
    <caption><h2 class="title">요청 정보 및 헤더 정보 출력하기</h2></caption>
    <hr>
    <ul class="list">
        <li><span>메시지</span> : <strong><%=msg%></strong></li>
        <li><span>프로토콜</span> : <strong><%=request.getProtocol()%></strong></li>
        <li><span>요청된 서버 이름</span> : <strong><%=request.getServletPath()%></strong></li>
        ...
        <li><span>호스트</span> : <strong><%=request.getHeader("host")%></strong></li>
    </ul>
    <hr>
    <br>
    <hr>
    <h2 class="class">헤더정보</h2>
