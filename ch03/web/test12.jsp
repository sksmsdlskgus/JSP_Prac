...
<head>
    ...
    <%
        ...
        mList.add(new Member(3,"kim","7979","김현경",90));
        mList.add(new Member(4,"park","1234","박진권",80));
        mList.add(new Member(5,"shin","4321","신승원",85));
    %>
</head>
<body>
<div class="container">
    ...
    <c:set var="name" value="김천사" scope="session" />
    <c:out value="${name }"/>
    <hr>
